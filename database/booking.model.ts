...
// Create index on eventId for faster queries (e.g., finding all bookings for an events)
BookingSchema.index({eventId: 1});

// Compound index for checking duplicate bookings (same email for same events)
